CREATE TABLE users (
                       ...
                       password_reset_expires_at TIMESTAMP NULL DEFAULT NULL COMMENT 'Expiration timestamp for password reset token',
                       INDEX idx_uuid (uuid),
...
INSERT INTO `admin` (`id`, `email`, `password`, `name`, `created_at`, `updated_at`, `last_sign_in_at`, `is_active`) VALUES
    (1,	'admin@litesupabase.com',	'$2y$10$la7mYyAOusNeYII1Iuj7YOw74L.jK0qpT0S4w.1bVOJg4YKGcQkH.',	'admin',	'2025-05-07 09:05:32',	'2025-07-29 07:10:08',	'2025-07-29 07:10:08',	1);
